...
This is a *separate* service from ``DocumentAnalyzerProcessor`` —
the original OCR is left untouched.
"""
...
class RewizorOCRService:
    ...
    def extract(self, image_path: str) -> Dict[str, Any]:
        ...
        :func:`src.integrations.rewizor.mapper.map_invoice_to_epp`.
        """
    ...
    def _normalize(data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # doc_type validation
        from src.integrations.rewizor.constants import VALID_DOC_TYPES, DOC_TYPE_PURCHASE_INVOICE
    ...
    # ------------------------------------------------------------------
    # Image handling (same approach as existing OCR, kept self-contained)
    # ------------------------------------------------------------------
